...
export default function ReceptionistAppointmentsPage() {
  ...
  return (
    <div>
      <h1 className="font-display text-3xl mb-1">Booking requests</h1>
      <p className="text-forest-500/70 text-sm mb-8">Online requests from the website, waiting on the front desk.</p>
